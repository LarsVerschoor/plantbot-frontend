...
function Navigation() {
    ...
    return (
        <nav className="bg-white rounded-b-md shadow-md px-4 py-3 w-full sticky absolute top-0">
            <div className="max-w-page flex justify-between mx-auto">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <NavigationLink to="/chat" isCurrent={isCurrent('/chat')}>Ask AI</NavigationLink>
                </div>
